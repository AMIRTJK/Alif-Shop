    ...
    <>
      <main>
        <header className="sticky z-40 w-full py-[24px] border-b-[1px] mb-[24px]">
          <nav className="menu-category max-w-[1192px] px-[32px] mx-auto flex items-center justify-between">
            <Link to="/">
              <LogoHeader />
            </Link>
            <button
            ...
            <div className="panel-nav flex items-center justify-between gap-[15px]">
        ...
        <footer className="bg-[#222222] py-[50px]">
          <div className="footer-top max-w-[1192px] border-b-[1px] py-[25px] border-[#f3f4f522] mx-auto px-[32px] flex justify-between items-start text-[#fff]">
